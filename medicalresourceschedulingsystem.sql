...
CREATE TABLE `accounttb`  (
  `accountNum` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '登录账号',
  `accountPwd` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '123456',
...
CREATE TABLE `admintb`  (
  `adminNum` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '管理员账号',
...
CREATE TABLE `applytb`  (
  `hospitalNum` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '申请医院的账号',
  ...
  `operationAccount` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '操作者账号',
...
CREATE TABLE `hospitalmesstb`  (
  `hospitalNum` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '医院账号',
  ...
  `voluns` int(255) NULL DEFAULT NULL COMMENT '医院所需自愿者数',
...
CREATE TABLE `patienttb`  (
  ...
  `hospitalNum` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '所在医院的账号',
...
CREATE TABLE `volunteerstb`  (
  `volunteerNum` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '自愿者账号',
  ...
  `hospitalNum` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '自愿者所在医院的账号',
  `isJoin` int(255) NULL DEFAULT 0,
...
-- ----------------------------
-- Triggers structure for table patienttb
-- ----------------------------
DROP TRIGGER IF EXISTS `autoSubBedNum`;
delimiter ;;
CREATE TRIGGER `autoSubBedNum` AFTER INSERT ON `patienttb` FOR EACH ROW BEGIN
	UPDATE hospitalmesstb SET emptys=emptys-1 where hospitalNum = new.hospitalNum;
END
;;
delimiter ;
...
-- Triggers structure for table patienttb
-- ----------------------------
DROP TRIGGER IF EXISTS `autoAddBedNum`;
delimiter ;;
CREATE TRIGGER `autoAddBedNum` BEFORE UPDATE ON `patienttb` FOR EACH ROW BEGIN
